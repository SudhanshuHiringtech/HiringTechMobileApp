...
const Login = ({ route }) => {
    ...
    const GoogleAuthentication = () => {
        setIsGoogleAuthVisible(true); // Update state to render GoogleAuth
    };
            ...
            <ScrollView>
                ...
                {item === 1 ? (
                    <View style={{ alignItems: 'center', marginTop: 20 }}>
                        <Text style={{ fontSize: 16, fontWeight: '600', color: '#000000' }}>Candidate Login</Text>
                    </View>
                ) : (
                    <View style={{ alignItems: 'center', marginTop: 20 }}>
                        <Text style={{ fontSize: 16, fontWeight: '600', color: '#000000' }}>HR Login</Text>
                    </View>
                )}
                ...
                <TouchableOpacity
                    ...
                    onPress={GoogleAuthentication} // Trigger GoogleAuthentication on press
                >
                ...
                {/* Conditionally render GoogleAuth based on state */}
                {isGoogleAuthVisible && (
                    <GoogleAuth navigation={navigation} authType="login" />
                )}
                ...
                <View style={[styles.signupViewStyle]}>
                    ...
                    {item === 1 ? (
                        ...
                        >
                            <Text style={[styles.signupTextStlye]}>Register</Text>
                        </TouchableOpacity>
                    ) : (
                        <TouchableOpacity
                            onPress={() => {
                        ...
                        >
                            <Text style={[styles.signupTextStlye]}>Sign Up</Text>
                        </TouchableOpacity>
                    )}
                </View>
            </ScrollView>
